...
if(isset($_POST["submitted"]) && $_POST["submitted"] == "yes")
{
	...
	$validate_user_information = mysqli_query($dbc , "select * from `friendship_system_users_table` where `username` = '".mysqli_real_escape_string($dbc, $username)."' and `password` = '".mysqli_real_escape_string($dbc, $encrypted_md5_password)."'");
...
<div style="width:300px;float:left;" align="left"><input type="text" name="username" id="username" value="" class="textAreaBoxInputs"></div><br clear="all"><br clear="all">
...
<input type="submit" name="submit" id="" value="Login" style="margin-right:50px;" class="general_button_g">
<a href="signup.php" style="text-decoration:none;" class="general_button_g">Register</a>
